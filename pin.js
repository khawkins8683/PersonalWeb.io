...
PinUsa.prototype.pinPixelLocation = function(){
	...
	let marginOffsetX = document.getElementById("travel").offsetLeft;
	
	let x = (fx.m*this.location.long + fx.b) - marginOffsetX + scrollLeft -10;

	let fy = linearFit(WA,FL,1);
	let scrollTop= window.pageYOffset || document.documentElement.scrollTop;
	let marginOffsetY = document.getElementById("travel").offsetTop + 90;
